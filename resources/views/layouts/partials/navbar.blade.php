<nav class="{{ Route::currentRouteName() == 'posts.single' ? '' : 'sticky' }} top-0 px-4 py-4 w-full bg-white/75 dark:bg-gray-800/75" style="z-index: 999999999">
  <div class="flex justify-center items-center max-w-screen-xl mx-auto w-full" >
    ...
    <div class="hidden space-x-12 lg:flex flex-1 justify-center items-center">
      <a class="dark:text-gray-100 transition-colors p-0.5 pl-3 pr-3 font-bold rounded-full {{ Request::path() == $homeRoute ? 'hover:bg-fuchsia-400 bg-fuchsia-500 text-white' : 'hover:bg-fuchsia-400/25 text-gray-600' }}" href="{{ $homeRouteUrl }}">Home</a>
      <a class="dark:text-gray-100 transition-colors p-0.5 pl-3 pr-3 font-bold rounded-full {{ Request::path() == $postsRoute ? 'hover:bg-fuchsia-400 bg-fuchsia-500 text-white' : 'hover:bg-fuchsia-400/25 text-gray-600' }}" href="{{ $postsRouteUrl }}">Blog</a>
    ...
    <div class="hidden lg:flex space-x-8 items-center" >
      ...
      @guest
      <a class="dark:text-gray-100 transition p-1 pl-2 pr-2 text-gray-600 font-bold border-solid border-2 dark:border-gray-100 border-gray-600 rounded-full" href="{{ route('login') }}">Sign In</a>
      @endguest
    </div>
