...
@if(session()->get('error'))
    <span>Error: {{ session()->get('error') }}</span>
@endif
<div class="w-full mx-auto">
    <form id="create_post" class="flex flex-col space-y-12" enctype="multipart/form-data">
        ...
        <div class="w-full flex flex-row space-x-12 justify-between items-center pl-4 pr-4" >
            ...
            <a class="dark:bg-gray-800 dark:hover:bg-gray-900 p-3 dark:text-zinc-300 rounded-md transition-colors shadow-md whitespace-nowrap mt-4 mb-4" href="{{ route('posts.index') }}" >Back to articles</a>
        </div>
        <div class="w-full">
